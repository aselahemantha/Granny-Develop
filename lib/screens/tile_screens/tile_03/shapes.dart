...
class _ShapesState extends State<Shapes> {
  // State variables to store the selected shape's image and title
  String selectedImage = AppConstants.shapes[0].image;
  String selectedTitle = AppConstants.shapes[0].name;
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            width: 280, // Set width of the box
                            height: 280, // Set height of the box
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: GridView.builder(
                                    ...
                                    itemCount: AppConstants.shapes.length, // 9 items
                                    itemBuilder: (context, index) {
                                      final shape = AppConstants.shapes[index];
                                      return GestureDetector(
                                        onTap: () {
                                          // Update the state with the selected shape's details
                                          setState(() {
                                            selectedImage = shape.image;
                                            selectedTitle = shape.name;
                                          });
                                        },
                                        child: ClipRRect(
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Image.asset(
                                                  shape.image, // Use appropriate image
