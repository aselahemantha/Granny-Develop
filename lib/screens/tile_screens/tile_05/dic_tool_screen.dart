...
class DictionaryToolMenu extends StatelessWidget {
  const DictionaryToolMenu({super.key});
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    BorderRadius.circular(12.0),
                                    child: Image.asset(
                                      AppConstants.dictionaryToolsImages[index % AppConstants.dictionaryToolsImages.length],
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
