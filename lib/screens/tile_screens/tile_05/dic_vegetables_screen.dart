...
class DictionaryVegetablesMenu extends StatelessWidget {
  const DictionaryVegetablesMenu({super.key});
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    BorderRadius.circular(12.0),
                                    child: Image.asset(
                                      AppConstants.dictionaryVegetablesImages[index % AppConstants.dictionaryVegetablesImages.length],
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
