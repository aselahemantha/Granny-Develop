...
class KidsTv extends StatelessWidget {
  const KidsTv({super.key});
                        ...
                        child: SizedBox(
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              String videoUrl = AppConstants.kidsTVVideoList[index];
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    BorderRadius.circular(12.0),
                                    child: Image.asset(
                                      AppConstants.kidsTVAlbumArt[index],
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
