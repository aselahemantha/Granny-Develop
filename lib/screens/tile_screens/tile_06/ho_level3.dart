...
import 'ho_level1.dart';

class HiddenObjectLevel3Screen extends StatefulWidget {
  const HiddenObjectLevel3Screen({super.key});

  @override
  HiddenObjectLevel3ScreenState createState() =>
      HiddenObjectLevel3ScreenState();
}

class HiddenObjectLevel3ScreenState extends State<HiddenObjectLevel3Screen> {
  late Timer _timer;
                  ...
                  onPressed: foundObjects.length == 3
                      ? () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  const HiddenObjectLevel1Screen(),
                            ),
                          );
                        }
                      : null,
