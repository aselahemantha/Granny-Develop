...
import 'ho_level2.dart';

class HiddenObjectLevel1Screen extends StatefulWidget {
  const HiddenObjectLevel1Screen({super.key});

  @override
  HiddenObjectLevel1ScreenState createState() => HiddenObjectLevel1ScreenState();
}

class HiddenObjectLevel1ScreenState extends State<HiddenObjectLevel1Screen> {
  late Timer _timer;
        ...
        children: [
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () => _onObjectFound(AppConstants.hiddenObjectName_1, AppConstants.hiddenObjectVoice_1),
              child: Image.asset(
          ...
          Positioned(
            ...
            left: 500,
            child: GestureDetector(
              onTap: () => _onObjectFound(AppConstants.hiddenObjectName_2, AppConstants.hiddenObjectVoice_2),
              child: Image.asset(
          ...
          Positioned(
            ...
            right: 200,
            child: GestureDetector(
              onTap: () => _onObjectFound(AppConstants.hiddenObjectName_3, AppConstants.hiddenObjectVoice_3),
              child: Image.asset(
            ...
            child: ElevatedButton(
              onPressed: foundObjects.length == 3
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const HiddenObjectLevel2Screen(),
                  ),
                );
              }
                  : null,
